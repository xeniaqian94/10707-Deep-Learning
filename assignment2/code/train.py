...
class Model:
    def __init__(self,,k,lr,minibatch_size):
        self.k=k
...
if __name__ == "__main__":
    ...
    parser.add_argument('-num_hidden_unit',type=int, help="num of hidden units", default=100)
    parser.add_argument('-k',type=int,help="CD-k sampling")
    ...
    print "input dimension is "+str(num_dimension)
    ...
    model=Model(args.num_hidden_unit,args.k,args.lr,args.minibatch_size)
